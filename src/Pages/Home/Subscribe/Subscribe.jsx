        ...
        <Container>
            <div className='lg:flex justify-around lg:py-12 md:py-8 py-5 bg-[#0472DB] text-center'>
                ...
                <div className='sm:pt-5'>
                    ...
                    <button className='py-5 lg:px-7 md:px-5 sm:px-4 px-3  rounded-r-lg hover:rounded-r-full bg-[#F7B919] text-white font-bold text-xl'><FaRegPaperPlane className='inline me-2 text-xl' /> SUBSCRIBE</button>
                </div>
            </div>
        </Container>
    );
