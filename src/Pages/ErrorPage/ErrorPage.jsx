    ...
    return (
        <div className=" text-center relative">
                ...
                <Link to='/' className="absolute bottom-[200px] left-5 lg:left-20 sm:left-5 md:left-5">
                    <button className='px-10 mb-5 rounded-lg text-xl fw-bold border-0 py-4 font-bold text-white bg-blue-700 hover:bg-[#F7B501]' title="Go to the Home">Back to Home</button>
                </Link>
        </div>
    );
};
